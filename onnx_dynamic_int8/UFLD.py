...
from onnx_dynamic_int8.configs.constant import tusimple_row_anchor,culane_row_anchor
import torch
...
class laneDetection():
    def __init__(self):
        ...
        print(self.cfg)
        self.cls_num_per_lane = 18  # 56
        self.row_anchor = tusimple_row_anchor  # tusimple
        self.cfg.griding_num = 200  # 调用的逻辑不知道怎么写的，这个一直被写死了，强行改了
